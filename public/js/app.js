...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _autolog_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./autolog.js */ "./resources/js/autolog.js");
...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["autolog"] = factory();else root["autolog"] = factory();
})(self, function () {
  return /******/function () {
    // webpackBootstrap
    /******/
    ...
    var autolog = {
      log: function log(text, type, time, autoClose) {
        if (text === void 0) {
          text = "";
        }
        if (type === void 0) {
        ...
        if (type.toString().startsWith("icon-")) {
          ...
          el.innerHTML = svgIcons[type] + "<span>".concat(text.replace(/\n/g, "</br>"), "</span>");
        }
        if (!autoClose) {
    ...
    __nested_webpack_exports__["default"] = autolog;
